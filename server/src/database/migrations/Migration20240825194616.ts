...
export class Migration20240825194616 extends Migration {
  override async up(): Promise<void> {
    ...
    this.addSql(
      'create table "product" ("id" serial primary key, "name" varchar(255) not null, "description" varchar(255) not null, "price" decimal not null, "quantity" int not null default 0, "category_id" int not null, "store_id" int not null);',
    );
    ...
    this.addSql(
      'create table "purchase" ("id" serial primary key, "date" timestamptz not null, "status" text check ("status" in (\'pending\', \'confirmed\', \'rejected\', \'started\', \'finished\', \'received\')) not null default \'pending\', "finished_at" timestamptz null, "cancel_cause" varchar(255) null, "student_id" uuid not null, "store_id" int not null);',
    );
