...
export class Migration20240831231402 extends Migration {
  override async up(): Promise<void> {
    ...
    this.addSql(
      'create table "store" ("id" serial primary key, "name" varchar(255) not null, "cnpj" varchar(14) not null, "university_id" int not null);',
    );
    ...
    this.addSql(
      'create table "user" ("id" uuid not null default gen_random_uuid(), "username" varchar(255) not null, "email" varchar(255) not null, "phone" varchar(15) not null, "name" varchar(255) not null, "password" varchar(255) not null, "type" text check ("type" in (\'student\', \'employee\')) not null, "created_at" varchar(255) not null, "store_id" int null, "university_course_id" int null, "points" int null default 0, constraint "user_pkey" primary key ("id"));',
    );
